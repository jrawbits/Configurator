...
This "do-nothing" tool demonstrates the essential properties of an
...
functions that will make tool development easier.

Speaking of easy, building an NMTK tool is just easy.  We knocked out
...
The hardest part of building a tool is constructing the configuration
...
Configurator to learn all you need to know about it.

Configurations have five main parts, which broadly track with what you
would expect to find in a reproducible research repository (q.v.):

The <strong>"info"</strong> section contains an overview of the
tool: its name, a block of HTML marked-up text that describes it --
that's what you're reading now -- and version information.

The <strong>"sample"</strong> section describes sample data and a sample
...
step of their own.  That section includes 

The <strong>"documentation"</strong> section provides links or files
...
the Non-Motorized Toolkit!

The real action happens in the remaining two sections:

The <strong>"input"</strong> section describes what the user has to
...
the text focuses on explaining the user interface properties.

The <strong>"output"</strong> section describes what the tool is going
